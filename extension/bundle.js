...
chrome.runtime.onMessage.addListener(function(msg, sender, sendResponse) {
  if (msg.command && (msg.command == "update_tweet_view")) {
  	var tweet = sentiment('this is a super awesome tweet').score.toString();
...
},{"../build/AFINN.json":3,"./tokenize":5,"_process":8,"lodash.assign":6}],5:[function(require,module,exports){
/**
...
},{"lodash.keys":7,"lodash.rest":2}],7:[function(require,module,exports){
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
